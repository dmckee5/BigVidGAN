...
def prepare_parser():
  ...
  parser.add_argument(
    ...
    help='What resolutions to use attention on for G (underscore separated) '
         '(default: %(default)s)')
  # xiaodan: add the argument of video length time step.
  parser.add_argument(
...
imsize_dict = {'I32': 32, 'I32_hdf5': 32,
               ...
               'Kinetics400':64,'Kinetics400_128':128}  #hardcoded needs to be changed later: Jugat
...
def name_from_config(config):
  ...
  'ts%d' % config['time_steps'],# xiaodan: add time_steps in name
